...
import { patchUpdateCustomPage } from '../../apis/custom/patchUpdateCustomPage.ts'
...
function EditCustomScreen({ route }: { route: any }) {
	...
	const submitEdit = async () => {
		...
		patchUpdateCustomPage(token as string, route.params.id, {
			style: '',
			data: title,
			node: data
		})
			...
			<ScrollView>
				<SafeAreaView style={style.container}>
					<TouchableOpacity style={style.header} onPress={() => navigation.goBack()}>
						...
						<Text style={style.title}>커스텀 수정하기</Text>
					</TouchableOpacity>
					<View style={style.main}>
						...
						<TouchableOpacity onPress={submitEdit} style={style.button}>
...
export default EditCustomScreen
